...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "fpcmeqvazvntdzt5"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//清洗强度(可下发可上报)
//备注:
#define DPID_INTENSITY 4
//超声洗(可下发可上报)
//备注:
#define DPID_ULTRASOUND_CLEANING 5
//工作模式(可下发可上报)
//备注:
#define DPID_WORK_MODE 6
//设备状态(只上报)
//备注:
#define DPID_STATUS 7
//预约时间(可下发可上报)
//备注:
#define DPID_APPOINTMENT_TIME 8
//剩余时间(只上报)
//备注:
#define DPID_REMAIN_TIME 9
//洗涤状态(只上报)
//备注:
#define DPID_CLEAN_STATE 10
//当前温度(只上报)
//备注:
#define DPID_TEMP_CURRENT 11
//水位设置(可下发可上报)
//备注:
#define DPID_WATER_SET 12
//单次水量(只上报)
//备注:
#define DPID_WATER_ONCE 13
//单次电量(只上报)
//备注:
#define DPID_CONSUMPTION_ONCE 14
//洗涤量设置(可下发可上报)
//备注:
#define DPID_WASH_NUMBER_SET 15
//耗水总量(只上报)
//备注:
#define DPID_WATER_TOTAL 16
//耗电总量(只上报)
//备注:
#define DPID_CONSUMPTION_TOTAL 17
//故障告警(只上报)
//备注:
#define DPID_FAULT 18
//童锁(可下发可上报)
//备注:
#define DPID_CHILD_LOCK 19
//灯光(可下发可上报)
//备注:
#define DPID_LIGHT 20
