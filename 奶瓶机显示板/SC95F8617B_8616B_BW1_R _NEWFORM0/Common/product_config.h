...
//2.1、按键显示增加简单驱动(取巧以显示标志位变化当判断条件)
//2.2、功能键的切换清除处理，按键开关功能，负载启停功能
//2.3、电源板更新10kntc
//3、增加按键切换逻辑
//3.1、初始亮电源，关机亮电源灭所有，开机灭电源允许按键
//3.2、开机后，有功能运行时启停键才能操作，亮时停止负载
...
//20260722 修复负载清零
//  暂停未关断强电负载：OutputEnable赋值2次而RelayEnable没有赋值
//20260912 修复未开功能键缺失PTC与臭氧控制问题
//  功能键启用时，先全关了负载后面再开，没有满足条件再次赋值就是关闭
//  功能键关闭时，只对部分负载进行控制
//  增加无论功能键开启关闭时，统一全关了负载后面再开
